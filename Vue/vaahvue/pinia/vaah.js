...
export const vaah = defineStore({
  ...
  actions: {
    ...
    confirmDialogDelete(callbackOnAccept) {
      this.confirmDialog(
        "Delete Confirmation",
        "Do you want to delete record(s)?",
        callbackOnAccept
      );
    },
    confirmDialogDeleteAll(callbackOnAccept) {
      this.confirmDialog(
        "Delete Confirmation",
        "Do you want to Delete all record(s)?",
        callbackOnAccept
      );
    },
    //----------------------------------------------------------
    ...
    confirmDialogActivate(callbackOnAccept) {
      this.confirmDialog(
        ...
        "Do you want to Activate all record(s)?",
        callbackOnAccept
      );
    },
    ...
    confirmDialogDeactivate(callbackOnAccept) {
      this.confirmDialog(
        ...
        "Do you want to Deactivate all record(s)?",
        callbackOnAccept
      );
    },
    ...
    confirmDialogTrash(callbackOnAccept) {
      this.confirmDialog(
        "Trash Confirmation",
        "Do you want to Trash all record(s)?",
        callbackOnAccept
      );
    },
    ...
    confirmDialogRestore(callbackOnAccept) {
      this.confirmDialog(
        ...
        "Do you want to Restore all record(s)?",
        callbackOnAccept
      );
    },
